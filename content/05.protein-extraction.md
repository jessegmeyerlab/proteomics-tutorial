...
Compatibility with the protease (typically trypsin) and peptide cleanup steps will need to be considered. Of note, detergents can be incomaptible with LC-MS workflows as they can cause ion suppression and column clogging. 
