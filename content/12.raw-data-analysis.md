...
Instrument calibrations in regular intervals help ensure that performance is appropriate.
During the calibration you can check injection times and intensity of the ions of your calibration mix.
To find out if your mass spectrometer is performing as expected, you can analyze complex samples, such as tryptic digests of whole-cell lysates (e.g. HeLa cells, HEK cells, yeast, etc.) or tryptic digests of purified proteins.
These digests should be analyzed after every instrument calibration and if required in between samples when acquiring more extensive batches.
Measured tryptic digests can be searched with software of your choice and the numbers of identified peptide precursors and proteins can be compared.
Measurments of digested purified proteins are great for identifying retention time shifts and mass accuracy problems. 
...
Electrospray stability tends to worsen over time with column wear-out, as well as when measuring samples with residual contaminants, such as salts or detergents. 
