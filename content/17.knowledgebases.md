...
For most shared raw mass spectrometry data, none of the data was compiled _in toto_ to derive at a knowledge base of all detectable proteins in an organism.
