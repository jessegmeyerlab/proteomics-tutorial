...
Moreover, by providing an increased peptide diversity, the use of multiple proteases can expand sequence coverage and increase the probability of finding peptides which are unique to single proteins [@DOI: 10.1021/acs.jproteome.9b00330]. A multi-protease approach can also improve the identification of mispredicted N-Termini and signal peptides for small proteins [@DOI: 10.1021/acs.jproteome.1c00115]. Therefore, integrating multiple-protease data can increase the number of proteins identified [@DOI: 10.3390/ijms20225630; @DOI: 10.1074/mcp.M113.035170], the number of identified post-translational modifications [@DOI: 10.1021/acs.jproteome.9b00330; @DOI: 10.1016/j.celrep.2015.05.029] and decrease the ambiguity of the protein group list [@DOI: 10.1021/acs.jproteome.9b00330].
