...
Quantification of peptides by LFQ is routinely performed by many commercial and freely available proteomics software. 
...
Metabolic labeling, e.g. stable isotope labeling in amino acid cell culture (SILAC) or , and chemical labeling, e.g. amine-modifying tags for relative and absolute quantification (mTRAQ) or dimethyl labeling, provide MS1-level peptide quantification. 
The labeling of each sample imparts mass shifts (e.g. 4 Da, 8 Da) which can be detected within the MS1 full scan.
The ability to label samples in cell culture enables impactful quantitative biology experiments [@DOI:https://doi.org/10.1016/j.celrep.2013.01.003; https://doi.org/10.1038/nmeth.1647].
These approaches have nearly exclusively been performed using data-dependent acquisition (DDA) strategies. 
However, recent work employing faster instrumentation has shown the benefits of chemical labeling with 3-plex mTRAQ labels for data-independent acquisition (DIA) [@DOI: https://doi.org/10.1038/s41587-022-01389-w; https://doi.org/10.15252/msb.202211503. 
As new tags with higher plexing become available, strategies like plexDIA and mDIA are sure to benefit [@DOI: https://doi.org/10.1038/s41587-022-01389-w; https://doi.org/10.15252/msb.202211503].
...
Commercial isobaric tags include tandem mass tags (TMT) [@DOI: https://doi.org/10.1021/ac0262560] and isobaric tags for relative and absolute quantification (iTRAQ) [@DOI: https://doi.org/10.1074/mcp.M400129-MCP200] amongst others, and several non-commercial options have also been developed [@DOI: https://doi.org/10.1021/ac902778d]. 
10- and 11-plex TMT kits were recently supplanted by proline-based TMT tags (TMTpro), originally introduced as 16-plex kits in 2019 [@DOI:https://doi.org/10.1021/acs.analchem.9b04474] and upgraded to an 18-plex platform in 2021 [@DOI:10.1021/acs.jproteome.1c00168]. 
...
As with peptide LFQ, the b- and y-type fragment ion peaks are still used to identify amino acid sequences of peptides, from which proteins can be inferred. 
Since it is possible to label most tryptic peptides with an isobaric mass tag at least at the n-termini, numerous peptides from the same protein can be detected and quantified, thus leading to an increase in the confidence in both protein identification and quantification [@PMID:25337643, https://doi.org/10.1146/annurev-biodatasci-080917-013516]. 
...
TMT works best with MS which allow quantitation at MS3-level with higher accuracy (e.g.: Thermo’s Orbitrap Tribrid instruments) [@PMID:25337643; https://doi.org/10.1021/acs.analchem.3c01155] by limiting the ratio distortion of co-isolated precursors within isobaric multiplexed quantitative proteomics [@PMID:21963607; https://doi.org/10.1021/ac502040v].
Infrared photoactivation of co-isolated TMT fragment ions generates more quantitative reporter ion generation and sensitivity relative to standard beam-type collisional activation [@DOI:https://doi.org/10.1021/acs.analchem.1c05398] 
