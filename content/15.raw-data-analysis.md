...
In any DIA software, we still use the target decoy approach to estimate the significance of candidate peptide identifications. 
A non-comprehensive list of software for DIA data analysis is found in table 13-2.

Table 13-2 DIA freeware:
...
The reasons for such sparse usage of ML in proteomics data is the need for very large datasets comprised of 100s of samples, which is still rare in proteomics. 
