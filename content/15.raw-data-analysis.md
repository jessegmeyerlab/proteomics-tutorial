...
Differential expression proteins representations include relative abundance charts, heat maps, and volcano plots. 
In-depth functional analysis encompasses gene ontology, protein-protein interactions, and signaling pathways.
](images/Fig_12_Biological_interpretation.png){#fig:DIA-types tag="15" width="100%"}
