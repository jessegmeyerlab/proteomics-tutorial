...
One variation of ERLIC combines strong anion exchange, electrostatic repulsion, and hydrophilic interaction chromatography (SAX-ERLIC) has risen in popularity thanks to robustness and commercially available enrichment kits [@DOI:10.1007/978-1-0716-1241-5_8; @DOI:https://doi.org/10.1016/j.celrep.2023.112368].
...
Many plasma proteome studies involve the analysis of untreated, unenriched plasma (i.e., neat plasma) [@DOI: https://doi.org/10.1016/j.cels.2020.10.003; @DOI:https://doi.org/10.1016/j.xpro.2021.100856].
Even so, identifying protein biomarkers from biological samples such as blood is often obstructed by proteins present at higher concentrations. 
The top 14 most abundant proteins in human plasma constitute over 99% of the total protein mass.
...
#### New technologies: 
Newer methods of highly abundant protein depletion are based on the interaction between polymers such as bacterial cellulose nanofibers [@PMID:30219335], cryogels and nanomaterials [@DOI:10.1016/j.procbio.2010.07.007].  
