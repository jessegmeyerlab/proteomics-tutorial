...
1. Affinity purification coupled to mass spectrometry (AP-MS)
...
2. Avidity-based Extracellular Interaction Screen (APEX)
...
3. Biochemical Identification of Neighbors by proximity Labeling (BioID)
