...
Affinity purification coupled to mass spectrometry (AP-MS)is an approach that involves the purification of a target protein or protein complex using a specific antibody or tag, followed by mass spectrometry analysis to identify the interacting proteins.
