...
While it's true that "digestion" is commonly used in proteomics, it's important to note that "hydrolysis" is indeed a valid and widely accepted term in this context.
Hydrolysis refers specifically to the breaking of peptide bonds within proteins using enzymes such as trypsin, chymotrypsin, or other proteases. 
This process results in the generation of peptide fragments rather than the complete breakdown into amino acids as seen in total hydrolysis assays. 
The term "hydrolysis" accurately describes the mechanism of the chemical process of breaking down molecules by the addition of water, which is precisely what occurs during enzymatic digestion in proteomics. 
In fact, enzymatic hydrolysis is a more precise term in this context as it highlights the involvement of specific enzymes in the cleavage of peptide bonds.
Therefore, while "digestion" is indeed a widely used term, "enzymatic hydrolysis" more accurately describes the specific biochemical process involved in preparing proteomic samples for analysis. 
