...
In this project, we seek to provide an environment for researchers from all backgrounds and disciplines to contribute to the consolidation and synthesis of scientific information related to proteomics.
...
This Code of Conduct is adapted from [the COVID review](https://github.com/greenelab/covid19-review/edit/master/CODE_OF_CONDUCT.md), which was adapted from the [Contributor Covenant](https://www.contributor-covenant.org), [version 1.4](https://www.contributor-covenant.org/version/1/4/code-of-conduct.html).
